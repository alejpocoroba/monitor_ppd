...
# abril al día 20
a <- read_xlsx(paste_inp("m_mayo15_2023.xlsx"))
...
paste0("Número total de observaciones al 15 de mayo 2023: ", dim(df_)[1])
...
ggplot(
  ...
  labs(
    ...
    caption = paste0("Fuente: Monitor-PPD al 15/05/23 ")
  ) +
  # Escalas
